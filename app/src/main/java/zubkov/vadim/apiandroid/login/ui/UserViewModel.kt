...
import zubkov.vadim.apiandroid.login.domin.usecase.UserUseCase
import dagger.hilt.android.lifecycle.HiltViewModel
import zubkov.vadim.apiandroid.login.domin.entity.UserModelFactory
        ...
        if (email.value == null && password.value == null){
            ...
            viewModelScope.launch {
                ...
                if(result) {
                    ...
                    navigationController.navigate(route = Routes.Screen.route)
                }
